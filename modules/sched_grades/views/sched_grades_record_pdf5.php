...
<body>
  <h4><?= strtoupper('grading sheet') ?></h4>
  <h5 >

    <?php

      echo strtoupper($sem_sy['sem_sy_w']['csem']).', SY '.$sem_sy['sem_sy_w']['sy'];
   ?>
  ...
  <br />  
  <br /> 
  <table class="table table-bordered" id=""  width="95%" align="center">
            <tbody>
              <tr>
                ...
                ?>
                <td colspan="8"><h3><strong  class="redlight-label" >  <?=strtoupper($teacher_name)?>  </strong></h3></td>
              </tr>
             <tr>
               ...
               <td width="12%">TOTAL UNITS :</td>
               <td width="3%"><strong><?=$check_sched[0]['totalunits']?></strong></td>
             </tr>
             <tr>
               <td>Description : </td>
               <td colspan="7"><strong  class="redlight-label" ><?=strtoupper($subject_info['sched_query'][0]->description)?></strong></td>
             </tr>
             <tr>
               <td>Schedule :</td>
               <td colspan="5">
