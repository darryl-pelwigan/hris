            ...
            <div class="col-lg-12">
               <div class="panel panel-success " data-panel-body="subject_excel_file">
                    ...
                    <div class="panel-body collapse  in" id="subject_excel_file">
                      <table class="table table-border table-hover hidden">
                        <thead>
                          <tr>
                            <th>FILENAME</th>
                            <th>GRADING</th>
 ...
 <div class="panel panel-default panel-overflow">
    ...
    <div class="panel-body">
      <div class="alert alert-info"> <strong  class="red">NOTE:</strong> PLEASE ENTER THE CORRECT GRADE WITH DECIMAL VALUE </div>
      <div class="alert alert-info"> <strong class="red">NOTE:</strong> PLEASE SUBMIT ALL GRADE TO GENERATE COMPLETE PDF </div>
     <?php

     if($print_this != ''){ ?>
      <form method="POST"  target="__blank" action="<?=base_url('sched_grades/export_pdf')?>" style="margin-bottom: 4px;">
            ...
            <thead>
                <tr>
                    ...
                    <?php if($check_sched[0]['semester'] != 3 || $smpt ){ ?>
                         <th>PRELIM <br />
                          <?php if(!$imp_excel['prelim']){ ?>
                              <img src="<?=base_url('assets/images/icons/CSV.png')?>" onclick="$(this).importDataCs('<?=$sched_id?>','<?=strtoupper($subject_info['sched_query'][0]->description)?>','PRELIM','pre');" width="20">
                         <?php } ?>
                         </th>
                    <?php } ?>
                    <th>MIDTERM
                        <br />
                         <?php if(!$imp_excel['midterm']){ ?>
                        <img src="<?=base_url('assets/images/icons/CSV.png')?>" onclick="$(this).importDataCs('<?=$sched_id?>','<?=strtoupper($subject_info['sched_query'][0]->description)?>','MIDTERM','mid');" width="20">
                       <?php } ?>
                    </th>
                    <th>TENTATIVE FINAL
                        <br />
