    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <a href='<?=base_url()?>ViewSubmittedGradesSAGSO'>&#8592; Back</a><br/>
                      ...
                      <table class="table table-border table-hover">
                        ...
                        <tbody>
                              ...
                              foreach ($excel_list as $key => $value) {
                                  echo '<tr>';
                                      echo '<td> <form method="POST" action="'.base_url('check_submitted/check_submitted_sagso/download_excel').'" ><input type="hidden" name="sched_id" value="'.$this->input->get('data_key').'" /><input type="hidden" name="excel_file" value="'.$this->encryption->encrypt($value->id).'" /> <button type="submit" class="btn btn-success" > DOWNLOAD </button></form></td>';
 ...
 <div class="panel panel-default panel-overflow">
    ...
    <div class="panel-body">
       <form method="POST"  target="__blank" action="<?=base_url('check_submitted/check_submitted_sagso/export_pdf')?>">
