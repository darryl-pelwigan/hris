...
$.fn.approvedGRADEX = function(type,sched_id){
    ...
    swal({
      ...
      customClass: 'animated bounceInDown'
        ...
        $.ajax({
                    type: "POST",
                    url: "<?=base_url('check_submitted/check_submitted_registrar/submit_grade_review')?>",
                    data : {
                            sched_id : sched_id,
                            type:type,
                    },
...
$.fn.approvedRequestUpdate = function(type,sched_id){
 $.ajax({
                    type: "POST",
                    url: "<?=base_url('check_submitted/check_submitted_registrar/get_request_remarks')?>",
                    data : {
                            sched_id : sched_id,
                            type:type,
                    },
                       ...
                       swal({
                            ...
                            customClass: 'animated bounceInDown'
                             ...
                             if (text) {
                                  $.ajax({
                                          type: "POST",
                                          url: "<?=base_url('check_submitted/check_submitted_registrar/submit_grade_request_approved')?>",
                                          data : {
                                                  sched_id : sched_id,
                                                  type:type,
                                                  message : text
