...
<style type="text/css" class="init">
	...
	.tbl_cutoff thead tr th, .tbl_payroll thead tr th {
		text-align: center;
		margin: 0 auto;
		font-weight: bold;
		font-size: 15px;
	...
	.attendance_tbl thead tr th, .overtime_tbl thead tr th {
		padding: 5px;
		text-align: center;
		margin: 0 auto;
		font-weight: bold;
	...
	.attendance_tbl tbody tr td, .overtime_tbl tbody tr td {
		padding: 5px;
		vertical-align: middle !important;
	}
...
/*	.ui-datepicker-calendar {
	...
	#staff_attendance_tbl {
		font-size: 15px;
	}	

	#staff_attendance_tbl thead tr th {
		text-align: center;
		vertical-align: middle !important;
	}
	#staff_attendance_tbl tbody tr td {
		text-align: center;
		vertical-align: middle !important;
	}
