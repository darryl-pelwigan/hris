...
class Viewcaptcha extends MY_Controller {
	...
	function index()
	{
		...
		if(in_array($font,array(base_url('/assets/plugins/captcha/fonts/ds-digi-webfont.ttf'),base_url('/assets/plugins/captcha/fonts/Stadium1956-Regular.otf'),base_url('/assets/plugins/captcha/fonts/actionj.ttf'),base_url('/assets/plugins/captcha/fonts/lexo.ttf'),base_url('/assets/plugins/captcha/fonts/squareo.ttf'),base_url('/assets/plugins/captcha/fonts/spyagency2_1acadital.ttf')))){
		...
		if( $captcha_config['shadow'] ){
			...
			imagettftext($captcha, $font_size, $angle, $text_pos_x+3, $text_pos_y + $captcha_config['shadow_offset_y'], $shadow_color, $font, $captcha_config['code']);	
		}
