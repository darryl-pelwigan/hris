                    ...
                    <fieldset id="YourAddress">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select name="p_add_country" class="form-control permanent-address selectpicker" id="Pcountry" data-live-search="true" >
                                        <option></option>
                                         <?php
                                        sort($the_origin);
                                                for($w=0;$w<count($the_origin);$w++){
                ...
                <div class="panel-body">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label><input onclick="$.fn.checkMother(this)" id="mDeceasedYes" type="checkbox" name="famBGDeceased_mom" value='yes' > Yes</label>&emsp;
                                <label><input onclick="$.fn.checkMother(this)" id="mDeceasedNo" type="checkbox" name='famBGDeceased_mom' value='no' checked> No</label>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Deceased:</label>
                            <div class="col-sm-9">
                                <label><input onclick="$.fn.checkFather(this)" id="fDeceasedYes" type="checkbox" name="famBGDeceased_dad" value='yes'> Yes</label>&emsp;
                                <label><input onclick="$.fn.checkFather(this)" id="fDeceasedNo" type="checkbox" name='famBGDeceased_dad' value='no' checked> No</label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <td><div class="form-group form-remove-margin"><textarea class="form-control" placeholder="Elementary" name="elem_educ" required><?=set_value('elem_educ')?></textarea></div>
                                <td><div class="form-group form-remove-margin"><textarea class="form-control" placeholder="Location" name="elem_educ_loc" required><?=set_value('elem_educ_loc')?></textarea></div>
                                    <td><div class="form-group form-remove-margin">
                                        <select class="form-control" name="elem_educ_yr">
                                                <?php
                                        ...
                                        <td><div class="form-group form-remove-margin"><textarea class="form-control" placeholder="Honors(if any)" name="elem_educ_hnr"></textarea></div></td>
                        </tr>
                        <tr>
                            <td><div class="form-group form-remove-margin"><textarea class="form-control" placeholder="High School" name="high_educ" required><?=set_value('high_educ')?></textarea></div>
                                <td><div class="form-group form-remove-margin"><textarea class="form-control" placeholder="Location" name="high_educ_loc" required><?=set_value('high_educ_loc')?></textarea></div>
                                    <td><div class="form-group form-remove-margin">
                                        <select class="form-control" name="high_educ_yr">
                                               <?php
                                        ...
                                        <td><div class="form-group form-remove-margin"><textarea class="form-control" placeholder="Honors(if any)" name="high_educ_hnr"></textarea></div></td>
                        </tr>
                    </table>
                </div>
                <!-- /.panel-body -->
