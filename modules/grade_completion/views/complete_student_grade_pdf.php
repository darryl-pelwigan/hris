...
<title>STUDENT GRADES COMPLETION</title>
...
<h4 class="text-center" style=" margin: 0; padding: 1px; font-weight: bold;">COMPUTATION OF NFE/INC</h4>
...
<hr   />
          ...
          <table class="table" style="margin: 3px 0 0 0;">
            <thead>
              ...
              <tr>
                        ...
                        <?php $final_grade = number_format( ($subject_grades[0]->prelim + $subject_grades[0]->midterm +  $tfinal_grade) / $div ,2);
                          if(ucwords(strtolower($grade_completion[0]->remarks)) == 'No Grade'){
                            $final_grade = 'NG';
                          }
                         if($div == 3): ?>
            ...
            <tr>
              ...
              <?php endif; ?>
                  ...
                  <td  class="text-center gr"><?=$tfinal_grade?></td>
                  <td  class="text-center grx" rowspan="4"><?=$final_grade?></td>
            </tr>
            <tr>
              <td></td>
              ...
              <td></td>
                ...
                <table class="table" style="margin: 0; padding: 0; width: 450px;">
                    <tbody>
                       <tr >
                         <td style="width: 150px;  text-align: right; margin-bottom: 10px;  ">Instructor's Signature : </td>
                         <td style="width: 250px;  margin-bottom: 10px; " class="gr"></td>

                         <td style="width: 50px; text-align: right; margin-bottom: 10px; ">Date : </td>
                         <td style="width: 150px; margin-bottom: 10px;  " class="gr"></td>
                       </tr>
     ...
     <tr>
          <td width="40%" style="font-size:10px;"><?=(strtoupper($student_info[0]->LastName))?>,<?=strtoupper($student_info[0]->FirstName)?> <?=(strtoupper($student_info[0]->MiddleName[0]))?> (<?=strtoupper($student_info[0]->code)?> - <?=$student_info[0]->yearlvl?>) </td>
          <td  width="10%" style="font-size:10px;" ><strong><?=$value?></strong></td>
          <td width="50%" style="text-align: right;font-size:10px;"><?=unix_to_human(now())?><small> This is a Computer Generated Document. Not valid as transfer credential.</small>
          </td>
       </tr>
   </table>
