...
<title>STUDENT GRADES COMPLETION FG </title>
          ...
          <table class="table" style="margin: 3px 0 0 0;">
            <thead>
              ...
              <tr>
                        ...
                        <?php $final_grade = number_format( ($grade_completion[0]->final_grade)  ,2);
                              if($grade_completion[0]->grade_remarks == 'No Grade'){
                                      $final_grade = 'NG';
                              }
                         ?>
            ...
            <tbody>
            <tr>
                  <td  class="text-center gr"><?=number_format( ($grade_completion[0]->tentativefinal)  ,2)?></td>
                  <td  class="text-center grx" rowspan="4"><?=$final_grade?></td>
                  <td  class="text-center grx" rowspan="4"><?=$grade_completion[0]->grade_remarks?></td>
            </tr>
            </tbody>
          </table>
