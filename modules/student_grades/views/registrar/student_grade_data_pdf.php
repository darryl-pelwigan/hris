...
hr.dotted {border-top: 1px dotted #000; background: transparent; }
...
if($sem==3)
   ...
   { $div=3;
   $pre='<th class="subject_info" >Prelim </th>';
   }
    ...
    <table class="table"  width="95%" align="center" style="padding: 0; margin: 5px 0 6px 0 ;">
      ...
      <tbody>
        <tr>
          ...
          <td class="student_info"><strong><?=strtoupper($student_info[0]->LastName)?> , <?=strtoupper($student_info[0]->FirstName)?> <?=strtoupper($student_info[0]->MiddleName[0])?>.</strong></td>
...
<table class='table' id="grades" style="margin-bottom: 0;" >
  <thead>
<tr>
  <th class="subject_info">SUBJECT CODE </th>
  <th colspan="3"   class="subject_info" >SUBJECT DESCRIPTION</th>
  <?=$pre?>
  <th class="subject_info">Midterm</th>
  <th  class="subject_info" >FINAL</th>
  <th  class="subject_info">REMARKS</th>
  <th  class="subject_info">UNIT</th>
</tr>
</thead>
<tbody>
<?=$grades_tbody?>
