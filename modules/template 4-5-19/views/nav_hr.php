        ...
        <nav class="navbar navbar-expand navbar-default  static-top">
            ...
            <ul class="nav navbar-top-links">
                <li class="dropdown_item_menu" id="dropdown_notification_item">
                    <!-- <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="notification_load" onclick="notification_reload()"> -->
                    ...
                    <ul class="dropdown-menu dropdown-alerts" id="notification_lists">
                    </ul>
                </li>
                <li class="pull-right">
