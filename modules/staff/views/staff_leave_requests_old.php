    ...
    <?php if($leave_credits): ?>
        ...
        <table class="table table-responsive">
            ...
            <tr class="text-center">
                <td>Approved <i class="fa fa-square fa-2x" style="color: #33cc66;"></i></td>
                <td>Disapproved <i class="fa fa-square fa-2x" style="color: #cc3333;"></i></td>
                <td>Pending <i class="fa fa-square fa-2x" style="color: #3399ff;"></i></td>
            </tr>
        </table><br/>
