...
class Profile_model extends CI_Model {
    ...
    function get_service_record($id){
        $this->db->select('pcc_job_history.staff_id ,pcc_position.position, pcc_job_history.date_from, pcc_job_history.date_to, pcc_departments.DEPTNAME, pcc_job_history.nature_employment, pcc_job_history.employment_stat ');
        $this->db->from('pcc_job_history');
        $this->db->join('pcc_position', 'pcc_position.id = pcc_job_history.position');
        $this->db->join('pcc_departments', 'pcc_departments.DEPTID = pcc_job_history.department');
    ...
    function get_profile_dependents($id){
     ...
     function get_leave_credit_log($empid, $leave_type){
        $this->db->select('l.*, lt.type as leave_type');
        $this->db->from('pcc_hr_leave l');
        $this->db->join('pcc_hr_leave_type lt', 'l.type_id = lt.id ', 'left');
